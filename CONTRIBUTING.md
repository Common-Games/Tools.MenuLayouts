...
1. Make an [Issue](https://github.com/common-games/Tools.CustomizableMenus/issues/new)
...
```json
    {
        "dependencies": {
            "com.common-games.Tools.CustomizableMenus": "https://github.com/YOUR_USER/Tools.CustomizableMenus.git"
        }
    }
```
